...
const statuses = {
    [roles.COMPANY_ADMIN_ROLE]: [statusesTTN.ARCHIVED_STATUS, statusesTTN.VERIFICATION_COMPLETED_STATUS],
    [roles.WAREHOUSE_DISPATCHER_ROLE]: [statusesTTN.REGISTERED_STATUS, statusesTTN.IN_STORAGE_STATUS, statusesTTN.RELEASE_ALLOWED_STATUS],
